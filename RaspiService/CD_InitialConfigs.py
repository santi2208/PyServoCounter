...
class CD_InitialConfigs(object):
    def __init__(self):
    ...
    def SetNumbers(self):
        ...
        for pos in self.Posiciones:
            numbers.append(self.SetNumber(i + 1, "Numero {}".format(i), pos))
            i = i + 1
    ...
    def SetFinalCharacter(self):
        fPos = [1, 0, 1, 0, 1, 1, 0] # C 
        return self.SetNumber("CAMBIO", "Caracter Finalizado F", fPos)
