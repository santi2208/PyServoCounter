...
if __name__ == '__main__':
    ...
    parser.add_argument('--web', help='URL servidor al que reportar estado - Default: None')
    ...
    httpProxy = HttpProxy(args.web) if args.web is not None else HttpProxy('http://192.168.0.18:8012/SetCounterState')
